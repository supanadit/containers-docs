...
This setup is for **development/testing purposes only**. For production use, see [ETCD High Availability](/etcd/ha/patroni) for TLS-secured cluster configuration.
:::
